...
_MODE_IDENTITY_SOULS: dict[str, list[str]] = {
    ...
    "catalog_clean": [
        ...
        "- visual hierarchy: garment is the SOLE PROTAGONIST. The model is a MANNEQUIN WITH WARMTH — she adds human scale and approachability but never personality that competes. The backdrop is INVISIBLE by design — it exists only to not distract. If the viewer remembers the model or the background, the hierarchy failed.",
