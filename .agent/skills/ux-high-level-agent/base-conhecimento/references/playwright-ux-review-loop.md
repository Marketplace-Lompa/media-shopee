...
Quando o objetivo for **repertorio visual** (nao rebuild imediato), usar um modo de captura adaptado:

1. Capturar galeria em multi-breakpoint + fullpage
2. Extrair cards/links visiveis (slugs, URLs, thumbs)
3. Abrir uma amostra de projetos para metadados (titulos, tags, temas)
4. Agrupar por clusters de linguagem visual
5. Promover diretrizes abstratas (nao copiar peças)

Saida minima adicional:

- contagem de cards analisados
- amostra de projetos inspecionados
- clusters/tendencias identificados
- diretrizes de identidade visual reaproveitaveis
- limitacoes do recorte (viés de curadoria/tempo)
